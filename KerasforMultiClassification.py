...
model.fit(x_train, dummy_y, epochs=200, batch_size=5, verbose=0)
...
# Hesaplanamıyor çünkü multi-classification
#accuracies=cross_val_score(estimator=model, X=x_test, y=dummy_y_test, cv=10)
