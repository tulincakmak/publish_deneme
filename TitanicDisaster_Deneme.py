...
history=classifier.fit(x_train, y_train, batch_size = 25, epochs = 200, validation_data=(x_test, y_test), validation_split=0.2)
...
train.to_csv(r"C:\Users\tulincakmak\Desktop\Train_FeatureExtraction.csv")