...
data=data.drop('hotel_impr', axis=1)    
...
result1=pd.concat([y_pred1, test['trivago_id'], test['avg_cpc'],test['clicks']], axis=1)


result1.to_excel('click_pred_for0807.xlsx')
